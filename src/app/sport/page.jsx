...
export default async function Api() {
    ...
    const economyNews = await fetch(`${API}category/6/`, {
        headers: {
    ...
    const economy_category = php.map((item) => {
        ...
        return (
            <Link key={item.id} href={`article/${item.category}/${item.id}`} data-aos="fade-up" data-aos-duration="1200" className="home-content-grid-item-one content-wrapper-header">
